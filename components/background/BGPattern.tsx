...
const maskClasses: Record<BGMaskType, string> = {
	'fade-edges': '[mask-image:radial-gradient(ellipse_at_center,var(--background),color-mix(in_srgb,var(--background)_0%,transparent))]',
	'fade-center': '[mask-image:radial-gradient(ellipse_at_center,color-mix(in_srgb,var(--background)_0%,transparent),var(--background))]',
